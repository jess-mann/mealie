<template>
  ...
  />
  <MealPlanCreateDialog v-model="mealDialog" :actions="actions" :meal="newMeal" />
...
const { open: mealDialog, newMeal, openDialog } = useMealplanDialog();
